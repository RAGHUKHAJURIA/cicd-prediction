...
function runCryptoTest() {
  console.log("process.env.ACCESS_TOKEN_ENCRYPTION_KEY:", JSON.stringify(process.env.ACCESS_TOKEN_ENCRYPTION_KEY));
  console.log("process.env.ACCESS_TOKEN_HMAC_SECRET:", JSON.stringify(process.env.ACCESS_TOKEN_HMAC_SECRET));
