...
const MODE1_NODES: WorkflowNode[] = [
  {
    ...
    description: "Paste any public or authorized private repository URL directly into the CI/CD Agent dashboard to trigger a zero-config, immediate audit of your pipeline configurations.",
    icon: Globe,
    x: 780,
    y: 60,
  ...
  },
  {
    ...
    description: "The CI/CD Agent requests the workflow files from the GitHub Contents API, fetching Actions workflows, GitLab CI, CircleCI, Dockerfiles, and Kubernetes manifests.",
    icon: DownloadCloud,
    x: 220,
    y: 160,
...
const MODE2_NODES: WorkflowNode[] = [
  ...
  },
  {
    ...
    description: "The CI/CD Agent platform webhook listener receives the push payload. The webhook's cryptographic HMAC signature is validated, and a scan worker is queued.",
    icon: Lock,
    x: 500,
    y: 60,
    column: "Your Platform",
...
const MODE3_NODES: WorkflowNode[] = [
  {
    ...
    description: "Install the official CI/CD Agent IDE extension to shift security testing left, identifying vulnerabilities directly within the workspace.",
    icon: Settings,
    x: 220,
    y: 60,
  ...
  },
  {
    ...
    description: "Integrate the CI/CD Agent Actions runner step into your pull request actions to automatically block vulnerabilities from being merged.",
    icon: PlusCircle,
    x: 780,
    y: 420,
  ...
  },
  {
    ...
    description: "Whenever code is pushed or a pull request is submitted, the GitHub runner spins up and calls the CI/CD Agent step automatically.",
    icon: Play,
    x: 780,
    y: 510,
    column: "GitHub Actions CI",
